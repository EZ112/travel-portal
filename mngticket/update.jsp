...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/updateticket.css">
  </head>
  <body>
    <%! String heading = "Update Ticket";%>
    <%! String tagline = "Update the ticket";%>
    <div class="container">
      ...
      <div class="section">
        <form action="">
          ...
          <div class="formItem">
                <input id="inInsertTicket" type="submit" name="inInsertTicket" value="Update Ticket">
          </div>
        </form>
      </div>
