...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/updatecities.css">
  </head>
  <body>
    <% String heading = "Update City";%>
    <% String tagline = "Update active city";%>
    <div class="container">
      ...
      <div class="section">
        <form action="">
          ...
          <div class="formItem">
                <input id="inAddCity" type="submit" name="inAddCity" value="Update City">
          </div>
        </form>
      </div>
